...
%>
<c:redirect url='join.jsp?idCheck=false' />
<%
	} else if (idOverlap == true) {
%>
<c:redirect url='join.jsp?idOverlap=true' />
<%
	} else if (!userPw.matches(pwCheck)) {
%>
<c:redirect url='join.jsp?pwCheck=false' />
<%
	} else if (!userEmail.matches(emailCheck)) {
%>
<c:redirect url='join.jsp?emailCheck=false' />
<%
	} else {
