						...
						<table class='table'>
							<tr>
								...
								<td>
									...
									<button type='button' id='idCheck'>중복확인</button> <span id='idMsg' class='msg'></span>
									<br>
							...
							<tr>
								<th>비밀번호</th>
								<td>
									<input id='userPw' type='password' /> <span id='pwMsg' class='msg'></span>
									<br>
							...
							<tr>
								<th>이름</th>
								<td>
									<input id='userName' type='text' /> <span id='nameMsg' class='msg'></span>
								</td>
							</tr>
							<tr>
								<th>전화번호</th>
								<td>
									<input id='userPhone' type='text' style='width: 80px;' maxlength='3'
								oninput="numberMaxLength(this);"/><strong>
									&nbsp; - &nbsp;</strong> <input id='userPhone2' type='text' style='width: 120px;' maxlength='4'
								oninput="numberMaxLength(this);"/><strong>
									&nbsp; - &nbsp;</strong> <input id='userPhone3' type='text' style='width: 120px;' maxlength='4'
								oninput="numberMaxLength(this);"/> <span id='phoneMsg' class='msg'></span>
								</td>
							</tr>
							<tr>
								<th>이메일</th>
								<td>
									<input id='userEmail' type='email' style='width: 370px;' /> <span id='emailMsg' class='msg'></span>
								</td>
							</tr>
						</table>
